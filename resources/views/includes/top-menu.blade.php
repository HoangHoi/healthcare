<nav class="navbar navbar-default">
    ...
    <div class="collapse navbar-collapse" id="app-navbar-collapse" style="padding: 0">
        <ul class="nav navbar-nav" style="margin: 0">
            ...
            <li class="navbar-item {!! $topActive == 2 ? 'active' : '' !!}"><a href="{!! route('home') !!}">Bệnh viện</a></li>
            <li class="navbar-item {!! $topActive == 3 ? 'active' : '' !!}"><a href="{!! route('home') !!}">Cẩm nang</a></li>
            <li class="navbar-item {!! $topActive == 4 ? 'active' : '' !!}"><a href="{!! route('home') !!}">Liên hệ</a></li>
        </ul>
    </div>
</nav>
